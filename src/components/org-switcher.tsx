        ...
        <SidebarMenuItem>
          <SidebarMenuButton size='lg' disabled>
            ...
            >
              ...
              <span className='text-muted-foreground truncate text-xs'>{t('Organizations')}</span>
            </div>
          </SidebarMenuButton>
        </SidebarMenuItem>
      </SidebarMenu>
      ...
      <SidebarMenu>
        <SidebarMenuItem>
          ...
          >
            ...
            >
              <span className='truncate font-medium'>{t('Create organization')}</span>
              <span className='text-muted-foreground truncate text-xs'>{t('Get started')}</span>
            </div>
          ...
          >
            ...
            <DropdownMenuGroup>
              ...
              >
                ...
                <div className='text-muted-foreground font-medium'>{t('Add organization')}</div>
              </DropdownMenuItem>
            </DropdownMenuGroup>
          </DropdownMenuContent>
        </DropdownMenu>
