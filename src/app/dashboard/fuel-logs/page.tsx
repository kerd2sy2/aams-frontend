...
export default function FuelLogsPage() {
  ...
  const avgPerLiter =
    stats.totalLiters > 0 ? (stats.totalCost / stats.totalLiters).toFixed(2) : '0.00';

  return (
    <PageContainer
      pageTitle='سجلات وتتبع الوقود'
      pageDescription='تتبع فواتير واستهلاك الوقود للمناديب وأسطول الدبابات بدقة'
      pageHeaderAction={
          ...
          <Card className='border-blue-100 bg-blue-50/40 dark:border-blue-950/40 dark:bg-blue-950/20'>
            ...
            <CardContent>
              <div className='text-2xl font-bold text-blue-700 dark:text-blue-400'>
                {stats.totalLiters.toLocaleString('ar-SA')}{' '}
                <span className='text-sm font-normal text-slate-500'>لتر</span>
              </div>
            </CardContent>
          </Card>
