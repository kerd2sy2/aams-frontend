...
export default function EditEmployeePage({
  ...
  useEffect(() => {
    if (employee) {
      ...
      setIqamaExpirationDate(employee.iqama_expiration_date ? employee.iqama_expiration_date.slice(0, 10) : '');
    ...
    <PageContainer>
      <div className="space-y-6 max-w-4xl mx-auto pb-10" dir="rtl">
        <PageHeader
          ...
          actions={
            <Button variant="outline" onClick={() => router.push(`/dashboard/employees/${id}`)} className="gap-2">
