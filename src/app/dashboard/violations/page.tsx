          ...
          <Card className='border-emerald-100 bg-emerald-50/40 dark:border-emerald-950/40 dark:bg-emerald-950/20'>
            ...
            <CardContent>
              <div className='text-2xl font-bold text-emerald-700 dark:text-emerald-400'>
                {stats.deductedAmount.toLocaleString('ar-SA')}{' '}
                <span className='text-sm font-normal text-slate-500'>ر.س</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className='border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900'>
            ...
            <CardContent>
              <div className='text-2xl font-bold text-slate-900 dark:text-slate-100'>
                {stats.totalCount}{' '}
                <span className='text-sm font-normal text-slate-500'>مخالفة</span>
              </div>
            </CardContent>
          </Card>
        </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            ...
                            {v.city && (
                              <span className='text-xs text-slate-400 block'>{v.city}</span>
                            )}
                          </TableCell>
                          <TableCell>
                            {v.employee ? (
