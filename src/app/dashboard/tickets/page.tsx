...
export default function SupportTicketsPage() {
  ...
  return (
    <PageContainer
      pageTitle='تذاكر الدعم والشكاوى'
      pageDescription='متابعة شكاوى وبلاغات المناديب والمشاكل التشغيلية والمالية'
      pageHeaderAction={
                ...
                <TableBody>
                  {loading ? (
                    ...
                    filteredTickets.map((t) => {
                      const pri = PRIORITY_BADGES[t.priority] || {
                        label: t.priority,
                        color: 'bg-slate-100'
                      };
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            <Badge variant='outline'>{CATEGORIES[t.category] || t.category}</Badge>
                          </TableCell>
                          <TableCell>
                            {t.employee ? (
