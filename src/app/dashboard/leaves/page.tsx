...
export default function LeavesPage() {
  ...
  return (
    <PageContainer
      pageTitle={t('Leave Requests', 'طلبات الإجازات للمناديب')}
      pageDescription={t('Leave Requests', 'تنظيم ومتابعة إجازات المناديب والموافقة عليها')}
      pageHeaderAction={
